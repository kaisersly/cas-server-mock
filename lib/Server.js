...
class Server {
  ...
  init() {
    ...
    this.app.set('key', this.key);
    this.app.set('password', this.password);
    ...
    this.app.use(express.static(path.dirname(require.resolve('angular')), staticServerOptions));
    this.app.use(express.static(path.dirname(require.resolve('angular-route')), staticServerOptions));
  }
